...
CREATE TABLE `comments_table` (
  ...
  `Comments_ID` varchar(45) NOT NULL,
  `Comments` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Assignment_ID`,`Comments_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Table to store Assignment Reviews and Comments';
...
-- Dump completed on 2015-04-23  1:10:50
